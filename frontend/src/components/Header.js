...
export default function Header() {
  return (
    <header className="flex space-x-6 items-center justify-between pl-[13px] pr-[13px] sm:w-[641.65px] sm:h-[48px] bg-[#121212] border rounded-[16px] border-[#2B2B2B]  pt-[8px] pb-[8px]">
      <svg
        width="31"
        height="30"
        viewBox="0 0 31 30"
      ...
      <nav className="flex items-center flex-wrap space-x-6 text-white">
        <a
          href="/pricing"
      ...
      <div>
        <button className="bg-white text-black text-sm font-medium px-4 py-1 w-[68.62px] h-[32px] rounded-md hover:bg-gray-200 transition-colors text-nowrap">
          Sign in
        </button>
      </div>
    </header>
